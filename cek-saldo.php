...
<head>
  ...
  <title>Sistem ATM - Cek Saldo</title>
...
<style>
  ...
  <div class="container">
    <h1>Selamat Datang, Sisa saldo Anda adalah:</h1>
    <h2><strong>Rp. <?php echo number_format($saldo, 2, ',', '.'); ?></strong></h2>
    <br>
    ...
    <ul class="list-group">
      ...
      <li class="list-group-item"><a href="dashboard.php">Kembali</a></li>
    </ul>
  </div>
